    ...
    <div class="container-fluid">
                    ...
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            ...
                            <div class="top-title-breadcrumb">
                                <h3 class="mb-0 restaurantTitle">{{trans('lang.mart_plural')}}</h3>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                                    <li class="breadcrumb-item"><a
                                            href="{!! route('marts') !!}">{{trans('lang.mart_plural')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{trans('lang.mart_details')}}</li>
                                </ol>
                            </div>
                        </div>
        ...
        <div class="resttab-sec mb-4">
            <div class="menu-tab">
                <ul>
                    <li class="active">
                        <a href="{{route('marts.view', $id)}}">{{trans('lang.tab_basic')}}</a>
                    </li>
                    <li>
                        <a href="{{route('marts.foods', $id)}}">{{trans('lang.tab_foods')}}</a>
                    </li>
                    <li>
                        <a href="{{route('marts.orders', $id)}}">{{trans('lang.tab_orders')}}</a>
                    </li>
                    <li>
            ...
            <div class="card border">
                <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                    <div class="card-header-title">
                        <h3 class="text-dark-2 mb-0 h4">{{trans('lang.mart_details')}}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="restaurant_info_left">
                                    ...
                                    <div class="sis-content pl-4">
                                        ...
                                        <ul class="p-0 info-list mb-0">
                                            <li class="d-flex align-items-center mb-2">
                                                <label
                                                    class="mb-0 font-wi font-semibold text-dark-2">{{trans('lang.mart_phone')}}</label>
                                                <span class="restaurant_phone"></span>
                                            </li>
                                            <li class="d-flex align-items-center mb-2">
                                                <label
                                                    class="mb-0 font-wi font-semibold text-dark-2">{{trans('lang.mart_address')}}</label>
                                                <span class="restaurant_address"></span>
                                            </li>
                                            <li class="d-flex align-items-center mb-2">
                                                <label
                                                    class="mb-0 font-wi font-semibold text-dark-2">{{trans('lang.mart_cuisines')}}</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label
                                            class="mb-0 font-wi font-semibold text-dark-2">{{trans('lang.mart_description')}}</label>
                    ...
                    <div class="card border">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label
                                        class="mb-1 font-wi font-semibold text-dark-2">{{trans('lang.mart_phone')}}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <label
                                        class="mb-1 font-wi font-semibold text-dark-2">{{trans('lang.mart_status')}}</label>
    ...
    async function getStoreNameFunction(vendorId) {
        ...
        await database.collection('vendors').where('id','==',vendorId).get().then(async function(snapshots) {
            if(!snapshots.empty) {
                ...
                $('.restaurantTitle').html('{{trans("lang.mart_plural")}} - '+vendorName);
