                 ...
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   ...
                   <div class="card-header-right d-flex align-items-center">
                    <div class="card-header-btn mr-3">
                        @if($id == '' && request()->is('payoutRequests/drivers'))
...
<script>
    ...
    $(function () {
        ...
        @if(empty($id))
            columns.push({ data: 'driver', orderable: true, searchable: true });
                @endif
        ...
        const defaultOrder = driverId ? [[3, 'desc']] : [[4, 'desc']];
        ...
        $('#payoutRequestTable').DataTable({
            ...
            order: defaultOrder,
            ajax: {
                url: '{{ route('payoutRequests.drivers.data') }}',
                data: function (d) {
                ...
                error: function (xhr) {
                    console.error('Failed to load driver payout requests:', xhr.responseText);
                }
            },
            columns: columns,
            columnDefs: [
